...
final class Server extends EventEmitter implements ServerInterface
{
     ...
     * $socket = new React\Socket\Server('127.0.0.1:8080', null, $context);
     * $socket = new React\Socket\Server('127.0.0.1:8080', $loop, $context);
     *
     * // new
     * $socket = new React\Socket\SocketServer('127.0.0.1:0');
     * $socket = new React\Socket\SocketServer('127.0.0.1:8080');
     * $socket = new React\Socket\SocketServer('127.0.0.1:8080', $context);
     * $socket = new React\Socket\SocketServer('127.0.0.1:8080', $context, $loop);
     * ```
     *
